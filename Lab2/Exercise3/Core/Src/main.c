...
void update7SEG(int index) {
	switch (index) {
		case 0:
		    ...
		    display7SEG(led_buffer[0], GPIOB, _a_Pin, _b_Pin, _c_Pin, _d_Pin, _e_Pin, _f_Pin, _g_Pin);
			break;
		case 1:
			HAL_GPIO_WritePin(EN0_GPIO_Port, EN0_Pin, SET);
			HAL_GPIO_WritePin(EN1_GPIO_Port, EN1_Pin, SET);
			...
			display7SEG(led_buffer[1], GPIOB, _a_Pin, _b_Pin, _c_Pin, _d_Pin, _e_Pin, _f_Pin, _g_Pin);
			break;
		case 2:
			HAL_GPIO_WritePin(EN0_GPIO_Port, EN0_Pin, SET);
			...
			HAL_GPIO_WritePin(EN2_GPIO_Port, EN2_Pin, SET);
			HAL_GPIO_WritePin(EN3_GPIO_Port, EN3_Pin, SET);
			display7SEG(led_buffer[2], GPIOB, _a_Pin, _b_Pin, _c_Pin, _d_Pin, _e_Pin, _f_Pin, _g_Pin);
			break;
		case 3:
			...
			HAL_GPIO_WritePin(EN2_GPIO_Port, EN2_Pin, SET);
			HAL_GPIO_WritePin(EN3_GPIO_Port, EN3_Pin, SET);
			display7SEG(led_buffer[3], GPIOB, _a_Pin, _b_Pin, _c_Pin, _d_Pin, _e_Pin, _f_Pin, _g_Pin);
			break;
	}
}
/* USER CODE END 0 */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, _a_Pin|_b_Pin|_c_Pin|_d_Pin
                          |_e_Pin|_f_Pin|_g_Pin, GPIO_PIN_RESET);
